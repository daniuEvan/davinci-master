...
public class Constants extends Consts {
     ...
     * 用户激活 / 重发激活邮件主题
     */
    public static final String USER_ACTIVATE_EMAIL_SUBJECT = "[税收大数据平台] 用户激活";
     ...
     * organization
     */
    public static final String INVITE_ORG_MEMBER_MAIL_SUBJECT = "[税收大数据平台] %s has invited you to join the %s organization";
