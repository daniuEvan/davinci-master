...
import {portal} from './PortalList.tsx'
...
export class DisplayList extends React.PureComponent<IDisplayListProps, IDisplayListStates> {
        ...
        <div className={styles.display}>
          <div className={styles.container} onClick={this.showDisplayFormModal('add')}>
            <div className={styles.central}>
              ...
              <div className={`${styles.item} ${styles.text}`}>创建新 数据大屏</div>
            </div>
          </div>
        </div>
      </Col>
  ...
  private renderDisplay (display: Display) {
    const coverStyle: React.CSSProperties = {
      ...
      // backgroundImage: `url(${require(`assets/images/bg${portal.avatar}.png`)}`
    }
    ...
    return (
      ...
      >
        <div className={displayClass}
             // style={coverStyle}>
             style={{ backgroundImage: `url(${require(`assets/images/bg5.png`)}` }}>
