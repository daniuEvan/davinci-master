...
interface IOperatingPanelStates {
  ...
  mode: WidgetMode
  currentWidgetlibs: IChartInfo[]  //定义这个currentWidgetlibs
...
export class OperatingPanel extends React.Component<IOperatingPanelProps, IOperatingPanelStates> {
  constructor (props) {
    ...
    this.state = {
      ...
      mode: 'pivot',
      currentWidgetlibs: widgetlibs['pivot'],  // 给currentWidgetlibs赋值
