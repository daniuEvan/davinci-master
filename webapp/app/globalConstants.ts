...
// tree 配置
export const CHART_TREE_STYLE = [
  { name: '向右分支', value: 'right' },
  { name: '向左分支', value: 'left' },
  { name: '向上分支', value: 'up' },
  { name: '向下分支', value: 'down' },
  { name: '辐射分支', value: 'round' },
  { name: '折线分支', value: 'poly' },
]

// graph
export const CHART_GRAPH_STYLE = [
  { name: '风格1', value: 'round' },
  { name: '风格2', value: 'small' },
  { name: '风格3', value: 'middle' },
  { name: '风格4', value: 'round2' },
  { name: '风格5', value: 'small2' },
]
